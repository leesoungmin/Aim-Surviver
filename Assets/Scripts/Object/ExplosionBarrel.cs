...
public class ExplosionBarrel : InteractionObject
{
    ...
    [SerializeField] float explosionDelayTime = 0.3f;
    [SerializeField] float explosionRadius = 10.0f;
    [SerializeField] float explosionForce = 1000.0f;
    ...
    public override void TakeDamage(int damage)
    {
        ...
        {
            StartCoroutine("ExlpodeBarrel");
        }
    }

    IEnumerator ExlpodeBarrel()
    {
